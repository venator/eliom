...
module type S_types = sig
  ...
  type ('get,'post,+'meth,+'attached,+'kind,
...
module type S = sig
  ...
  val service :
    ...
    unit ->
    ('get,unit,[> `Get],[> `Attached of a_s ], [> `Service ], 'tipo,
  ...
  val post_service :
    ...
    unit ->
    ('get, 'post, [> `Post],[> `Attached of a_s], 'kind,
  ...
  val put_service :
    ...
    ('get, Eliom_parameter.raw_post_data,
     [> `Put],[> `Attached of a_s],[> `Service ], 'tipo, 'gn,
  ...
  val delete_service :
    ...
    unit ->
    ('get, Eliom_parameter.raw_post_data,
     [> `Delete],[> `Attached of a_s],[> `Service ], 'tipo, 'gn,
     Eliom_parameter.no_param_name, [> `Registrable ], 'rt) service
  ...
  val coservice :
    ...
    rt:('rt, _) rt ->
    fallback:
      (unit, unit, [<`Get], [<`Attached of a_s], [<`Service ],
    ...
    unit ->
    ('get,unit,[> `Get],[> `Attached of a_s], [> `AttachedCoservice],
  ...
  val post_coservice :
    ...
    ('get, 'post, [>`Post], [> `Attached of a_s],
     [> `AttachedCoservice],'tipo, 'gn, 'pn, [> `Registrable ], 'rt)
      service
  ...
  val put_coservice :
    ...
    ('get, Eliom_parameter.raw_post_data,[> `Put],
     [> `Attached of a_s], [> `AttachedCoservice],
  ...
  val delete_coservice :
    ...
    unit ->
    ('get, Eliom_parameter.raw_post_data,
     [>`Delete], [> `Attached of a_s], [> `AttachedCoservice],
     'tipo, 'gn, Eliom_parameter.no_param_name,
     [> `Registrable ], 'rt) service
  ...
  val put_coservice' :
    ...
    unit ->
    ('get, Eliom_parameter.raw_post_data, [>`Put],
     [> `Nonattached of na_s], [>`NonattachedCoservice],
     [`WithoutSuffix], 'gn,
     Eliom_parameter.no_param_name, [> `Registrable ], 'rt) service
...
module type S_with_external = sig
  ...
  val external_service :
    ...
    get_params:
      ('get, [< `WithSuffix | `WithoutSuffix ] as 'tipo, 'gn)
        Eliom_parameter.params_type ->
    unit ->
    ('get, unit, [>`Get],[> `Attached of a_s],[> `External ],'tipo,
     'gn, unit, [> `Unregistrable ], 'rt) service
  ...
  val external_post_service :
    ...
    post_params:
      ('post, [ `WithoutSuffix ], 'pn) Eliom_parameter.params_type ->
    unit ->
    ('get, 'post, [>`Post],[> `Attached of a_s], [> `External ], 'tipo,
  ...
  val external_put_service :
    ...
    unit ->
    ('get, Eliom_parameter.raw_post_data,
     [> `Put], [> `Attached of a_s], [> `External ], 'tipo,
  ...
  val external_delete_service :
    ...
    unit ->
    ('get, Eliom_parameter.raw_post_data,
     [>`Delete ], [> `Attached of a_s], [> `External], 'tipo,
     'gn, Eliom_parameter.no_param_name, [> `Unregistrable ], 'rt)
      service
